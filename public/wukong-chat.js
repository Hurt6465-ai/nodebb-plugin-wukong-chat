...
(function () {
  ...
  var ICON = {
    ...
    ai: '<span class="cp-trans-icon" aria-hidden="true"><i class="fa fa-language" aria-hidden="true"></i><span class="cp-trans-fallback">译</span></span>'
  };
  ...
  function cpNormalizeActionIcons() {
    ...
    if (transBtn) transBtn.innerHTML = '<span class="cp-trans-icon" aria-hidden="true"><i class="fa fa-language" aria-hidden="true"></i><span class="cp-trans-fallback">译</span></span>';
  ...
  async function fetchWukongHistory(peerUid, startSeq, opts) {
    ...
    try {
      ...
      var u2 = "/bridge/get-history?login_uid=" + encodeURIComponent(state.myUid) + "&channel_id=" + encodeURIComponent(peerUid) + "&limit=" + encodeURIComponent(limit);
  ...
  function injectStyle() {
    ...
    var css = `
      ...
      /* v50 visual fixes: compact translate icon, strong bottom arrow, stable call menu. */
      #cp-chat-root .cp-trans-wa,
      #cp-chat-root .cp-trans-wa b{
        display:none!important;
      }
      #cp-chat-root .cp-trans-icon{
      ...
      #cp-chat-root .cp-trans-icon i{
        display:inline-block!important;
        font-size:13px!important;
        line-height:1!important;
        color:#8b5cf6!important;
      }
      #cp-chat-root .cp-trans-icon .cp-trans-fallback{
        display:none!important;
      ...
      #cp-chat-root .cp-quick-trans .cp-trans-icon{
        width:13px!important;
        height:13px!important;
        min-width:13px!important;
      }
      #cp-chat-root .cp-quick-trans .cp-trans-icon i{
        font-size:12px!important;
      }
      #cp-chat-root .cp-toggle-ai-send .cp-trans-icon{
        width:16px!important;
        height:16px!important;
      }
      #cp-chat-root .cp-toggle-ai-send .cp-trans-icon i{
      ...
      #cp-chat-root .cp-fab-bottom{
        ...
        color:#fff!important;
        box-shadow:0 8px 18px rgba(96,165,250,.28)!important;
      }
      #cp-chat-root .cp-fab-fa{
        display:inline-block!important;
      ...
      #cp-chat-root #cp-harmony-call-entry .cp-call-fallback{
        color:#1d4ed8!important;
        font-family:Arial,sans-serif!important;
        font-size:18px!important;
        line-height:1!important;
      ...
      #cp-chat-root #cp-harmony-call-pop button{
        width:100%!important;
      ...
      #cp-chat-root #cp-harmony-call-pop .cp-harmony-call-pop-main,
      #cp-chat-root #cp-harmony-call-pop .cp-harmony-call-pop-main b{
      ...
      #cp-chat-root #cp-harmony-call-pop .cp-harmony-call-pop-icon{
        width:32px!important;
        height:32px!important;
    ...
    var html = `
      <div id="cp-chat-root">
        ...
        <button id="cp-fab-bottom" class="cp-fab-bottom" title="回到底部" aria-label="回到底部">
          <i class="fa fa-arrow-down cp-fab-fa" aria-hidden="true"></i><span class="cp-fab-v" aria-hidden="true">↓</span>
        ...
        <footer class="cp-footer" id="cp-footer">
          <div style="text-align:center;">
            <div class="cp-translate-bar" id="cp-translate-bar">
              ...
              <button class="cp-toggle-ai-send" id="cp-send-translate-toggle" title="开启后：输入框内容会翻译成对方语言再发送"><span class="cp-trans-icon" aria-hidden="true"><i class="fa fa-language" aria-hidden="true"></i><span class="cp-trans-fallback">译</span></span></button>
            </div>
          </div>
