...
<link rel="preload" as="script" href="/plugins/nodebb-plugin-wukong-chat/static/wukong-chat.js?v=59">
<link rel="preload" as="script" href="/plugins/nodebb-plugin-wukong-chat/static/vendor/wukongimjssdk.umd.js?v=28">
<link rel="stylesheet" href="/plugins/nodebb-plugin-wukong-chat/static/wukong-chat.css?v=59">
...
<script>
(function () {
  var m = location.pathname.match(/\/wukong\/([^/?#]+)/i);
  ...
  window.CPChatHarmony.config = Object.assign({}, window.CPChatHarmony.config || {}, {
    ...
    cssUrl: "/plugins/nodebb-plugin-wukong-chat/static/wukong-chat.css?v=59",
...
<script charset="utf-8" src="/plugins/nodebb-plugin-wukong-chat/static/wukong-chat.js?v=59"></script>
<script>
(function () {
...
<script charset="utf-8" src="/plugins/nodebb-plugin-wukong-chat/static/cp-harmony-call.js?v=59"></script>
